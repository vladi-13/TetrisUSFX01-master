...
private:
	int numeroBloquesMetal;
	int numeroBloquesHielo;
	int numeroBloquesPiedra;
	int numeroBlqouesMadera;
	int numeroBloquesExplosivos;

public:
	void setBloqueMadera();
	void setBloqueMetal();
	void setBloquePiedra();
	void setBloqueHielo();
	void setBloqueExplosivo();
};
